...
/**
* JoinParams for params of the functions in code generator
* 
* @example
* // my_key_object = { type: 'String', b: 'bar', c: 'baz' }
* {{ my_array|join(', ') }}
* // => foo, bar, baz
*/

exports.joinParams = function (input, glue) {
  ...
  if (utils.isArray(input)) {
    ...
    for (i = 0; i < input.length-1; i++) {
      value = input[i]['type'] +' '+input[i]['name']; 
      out.push(value);
    }
    return out.join(glue);
  }
