...
try {
	...
	if ( command == 'generator' ){
		...
		if ( newType == "project" ) {
			...
			console.log( 'Jarvis > project name:',mProject.getName() );
			console.log( 'Jarvis > project type::',mProject.getType() );
			console.log( 'Jarvis > ptoject path::',mProject.getPath() );
		}
    ...
    console.log( 'Error in jarvis boot ; ',  err.message );
}